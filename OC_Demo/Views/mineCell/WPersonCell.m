...
@interface WPersonCell ()
@property(nonatomic,strong)UILabel *label;
@property(nonatomic,strong)UILabel *subLabel;

@property(nonatomic,strong)UIImageView *rightImg;
@end
@implementation WPersonCell
- (UILabel *)label{
    if (_label == nil){
...
- (void)setModel:(id<CellModelProtocol>)model{
    if ([model isKindOfClass:[WPersonCellModel class]]){
        WPersonCellModel *m = (WPersonCellModel *)model;
...
@implementation WPersonCellModel
- (NSString *)getCellID{
    
    return NSStringFromClass([WPersonCell class]);
}
